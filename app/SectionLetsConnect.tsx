    ...
    const socialMediaLinks = [
        {
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://www.linkedin.com/in/rashi-aggarwal-uiuxdesign/', '_blank'),
        },
        {
            initial: { y: 50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
        ...
        },
        {
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://github.com/rashi1227', '_blank')
        },
        {
            initial: { y: -50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
        ...
        },
        {
            ...
            height: 310,
            tabIndex: 0,
            onClick: () => window.open('mailto:rashiaggarwalofficial680@gmail.com', "_self")
        }
